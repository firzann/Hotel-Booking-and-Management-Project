						...
						{	
							...
							if($st=="Confirm")
							{
								...
								if($f1=="NO" )
								{
									...
									{
										echo "<script type='text/javascript'> alert('Sorry! Not Available Simple Room')</script>";
									}
										else if($f4=="NO")
										{
											...
											{	
												...
												echo "<script type='text/javascript'> window.location='home.php'</script>";
												 $type_of_room = 0;       
														...
														$psql = "INSERT INTO `payment`(`id`, `title`, `fname`, `lname`, `troom`, `tbed`, `nroom`, `cin`, `cout`,`pay`, `ttot`, `btot`,`fintot`,`noofdays`) VALUES ('$id','$title','$fname','$lname','$troom','$bed','$nroom','$cin','$cout','$pay','$ttot','$btot','$fintot','$days')";
